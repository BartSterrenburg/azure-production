...
router.put("/api/form/TRA/:id", formController.updateTRA)
...
router.get("/api/taakstap/:id", formController.getTaakStap)
router.put("/api/taakstap/:id", formController.updateTaakStap)
router.post("/api/taakstap", formController.saveTaakStap)
router.delete("/api/taakstap/:id", formController.deleteTaakStap)
router.get("/api/gezienVoorUitvoering/:id", formController.getGezienUitvoering)
router.put("/api/gezienVoorUitvoering/:id", formController.updateGezienUitvoering)
router.post("/api/gezienVoorUitvoering", formController.saveGezienUitvoering)
router.delete("/api/gezienVoorUitvoering/:id", formController.deleteGezienUitvoering)
